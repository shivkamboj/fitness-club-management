...
class UpdateTrainerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'phone' => [
                ...
                'string',
                'max:30',
                Rule::unique('users', 'phone')->ignore($trainerId),
            ],
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            'remove_profile_image' => filter_var($this->input('remove_profile_image'), FILTER_VALIDATE_BOOLEAN),
            'remove_background_image' => filter_var($this->input('remove_background_image'), FILTER_VALIDATE_BOOLEAN),
        ]);
    }
}
