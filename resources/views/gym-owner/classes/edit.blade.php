...
@section('page_heading', 'Edit Group Class')
...
<div class="gwb-card">
    <h2 class="fw-bold text-white mb-1 fs-4">Edit: {{ $class->name }}</h2>
    <p class="text-muted small mb-4 border-bottom border-secondary pb-3">Update the class details, schedule, and trainer assignment.</p>

    <form action="{{ route('gym-owner.classes.update', $class->id) }}" method="POST" id="classForm">
        @csrf
        @method('PUT')
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-6 col-md-2">
                ...
                <input type="number" id="duration_minutes" name="duration_minutes" min="5" max="480"
                       ...
                       value="{{ old('duration_minutes', $class->duration_minutes) }}" required>
            ...
            <div class="col-12">
                ...
                <textarea id="description" name="description" rows="3"
                          class="form-control bg-dark border-secondary text-white @error('description') is-invalid @enderror">{{ old('description', $class->description) }}</textarea>
        ...
        <div class="row g-3 mb-4">
            <div class="col-12">
                ...
                <div class="d-flex flex-wrap gap-2">
                    @php $existingDays = old('schedule_days', $class->schedule_days ?? []); @endphp
                    @foreach($daysOfWeek as $day)
                        <div class="day-toggle {{ in_array($day, $existingDays) ? 'selected' : '' }}"
            ...
            <div class="col-6 col-md-3">
                ...
                <input type="date" id="start_date" name="start_date"
                       ...
                       value="{{ old('start_date', $class->start_date ? $class->start_date->format('Y-m-d') : '') }}">
            ...
            <div class="col-6 col-md-3">
                ...
                <input type="text" id="location" name="location"
                       ...
                       value="{{ old('location', $class->location) }}" placeholder="e.g. Studio A">
        ...
        <div class="border-top border-secondary pt-3 d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-gwb-primary px-4">Update Class</button>
        </div>
    </form>
</div>
@endsection
