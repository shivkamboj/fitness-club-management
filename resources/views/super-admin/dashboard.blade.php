...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
    ...
    <div class="d-flex align-items-center gap-2 flex-wrap">
        <a href="{{ route('super-admin.gyms.index') }}" class="btn-gwb-primary">
            <i class="fa-solid fa-building-circle-check me-1"></i> Manage Gym Owners
        </a>
        <a href="{{ route('super-admin.contacts.index') }}" class="btn-gwb-secondary">
            <i class="fa-solid fa-envelope-open-text me-1"></i> Review Leads
        </a>
    </div>
</div>
    ...
    <div class="col-12">
        <div class="gwb-card mb-0">
            <div class="gwb-card-header">
                <h3 class="gwb-card-title"><i class="fa-solid fa-chart-column me-2"></i>New Gym Center Registrations (Last 7 Months)</h3>
            </div>
...
<div class="row g-4 mb-4">
    <div class="col-12 col-lg-7">
        <div class="gwb-card h-100 mb-0">
            <div class="gwb-card-header">
                <h3 class="gwb-card-title"><i class="fa-solid fa-building-shield me-2"></i>Registered Gym Centers</h3>
            ...
            @else
                <div class="text-center py-4">
                    <i class="fa-solid fa-building fs-4 text-muted mb-2"></i>
                    <div class="small text-muted">No gym centers registered yet.</div>
                </div>
            @endif
        </div>
    </div>
    ...
    <div class="col-12 col-lg-5">
        <div class="gwb-card h-100 mb-0">
            <div class="gwb-card-header">
                <h3 class="gwb-card-title text-warning"><i class="fa-solid fa-envelope-open me-2"></i>Recent Inquiries</h3>
            ...
            <div class="d-flex flex-column gap-3">
                ...
                @empty
                    <div class="text-center py-4">
                        <i class="fa-regular fa-envelope fs-4 text-muted mb-2"></i>
                        <div class="small text-muted">No contact inquiries yet.</div>
                    </div>
                @endforelse
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const canvas = document.getElementById('platformGymsChart');
    if (!canvas) return;
